...
\begin{frame}
    ...
    \framesubtitle{Different stages and kinematic regimes}

    \begin{center}
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=0.52\textwidth]{images/HP24-Weiyao-Ke-HF-Theory-2-crop-white.png}};
        \end{tikzpicture}
    \end{center}
    \vspace{-5pt}    
    \blfootnote{\scriptsize Ke - \textit{ Open Heavy Flavor: Theory} \href{https://indico.cern.ch/event/1339555/contributions/6038190/}{{\color{palgold}\texttt{[Hard Probes 24]$^\text{\tiny\faExternalLink}$}}}}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{custombox2}{{\normalsize Strong fields}}{palviolet}
            ...
            \begin{itemize}\itemsep0em 
                \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{palviolet}\blacktriangleright}$}}} 
                \scriptsize
                \item Strong longitudinal fields, dilute after $\tau\sim 1/{\color{red}Q_s}$
            \end{itemize}
            \end{varwidth}
        \end{custombox2}
        ...
        \begin{custombox2}{{\normalsize Correlation domains}}{palgold}
            ...
            \begin{itemize}\itemsep0em 
                \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{palgold}\blacktriangleright}$}}} 
                \scriptsize
                \item Fields correlated inside flux tubes of size $\sim 1/{\color{red}Q_s}$ 
            \end{itemize}
            \end{varwidth}
        \end{custombox2}
    ...
    \begin{itemize}\itemsep0em 
        ...
        \item \begin{center}Physics of glasma influenced by gluon {\color{red}saturation momentum $Q_s$}\end{center}
        \item \begin{center}Heavy quarks and jets may probe properties of the glasma fields\,\end{center}
    \end{itemize}
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \column{.4\textwidth}
        ...
        \begin{itemize}\itemsep0em 
            ...
            \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{palviolet}\blacktriangleright}$}}}
            \item {\bfseries\color{palviolet}Incompatible with $\boldsymbol{\kappa}$ during EKT}
        \end{itemize}    
    ...
    \begin{center}
        \begin{columns}[onlytextwidth,t]
           ...
           \begin{center}
                \begin{custombox2}{\normalsize Glasma+Wong approach}{palgold}
                    ...
                    \begin{itemize}\itemsep0em 
                        ...
                        \footnotesize
                        \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{palgold}\blacktriangleright}$}}} 
                        \item Azimuthal decorrelation due to glasma
           ...
           \begin{figure}
            ...
            \begin{center}
                \begin{custombox2}{\normalsize MC@sHQ+EPOS model}{Orange}
                    ...
                    \begin{itemize}\itemsep0em 
                        ...
                        \item Azimuthal decorrelation during QGP
                        \item Collisional + radiative energy loss effects
                        \item Small $p_T$ pairs decorrelate at later times
                    \end{itemize}
                    \end{varwidth}
                \end{custombox2}
            \end{center}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=0.85\columnwidth]{images/deltaphi_cccor_centrala.eps}
            \end{figure}
            \column{.02\textwidth}
        \end{columns}    
    \end{center}
